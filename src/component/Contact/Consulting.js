...
const Consulting = () => {
  return (
    <body className="consulting">
      ...
      <br></br><br></br>
      <h3>
      아마존 소비자 행동분석을 통해 'ㅁㄴㅇㄻㄴㅇㄹ'하는 전략이 필요합니다.
      고객이탈예측을 통해 이탈 고객과 아닌 고객을 분류하여 이탈고객에게는 한달이 경과하였을때 무료쿠폰 이메일을 보냅니다.
      구매 카테고리 예측을 통해 고객이 선호하는 상품을 위주로 광고합니다.
      고객 세분화를 통해 각 고객에 맞는 전략을 사용합니다. 등 수정예정.
      </h3>
    </body>
  );
};
