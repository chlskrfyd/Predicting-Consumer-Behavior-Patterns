      ...
      <div className='about_main'>
        ...
        <div className="about_box">
          ...
          <div className="about_txt_box">
            ...
            <br></br>경쟁사 대비 폭넓은 커버리지를 확보하고 있습니다.</div>

            <div className="about_txt1">정확한 위협 탐지</div>
            <div className="about_txt2">그래프 기반 관계 분석 엔진과 분석 팀이​
            <br></br>정확하게 위협요소를 탐지하고 근본 원인을 파악합니다.​</div>

            <div className="about_txt1">즉시 적용 가능한 인텔리전스</div>
            <div className="about_txt2">위협 그룹에 대한 이해를 기반으로 고객에게 특화된
            <br></br>즉시 적용 가능한 인텔리전스를 제공합니다.</div>
          </div>
